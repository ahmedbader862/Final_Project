const arabic = {
  ...
  removedFromCartToast: "تمت إزالته من العربة!",
  removedFromWishlistToast: "تمت إزالته من قائمة الرغبات",
  errorUpdatingWishlist: "خطأ في تحديث قائمة الرغبات",
  errorUpdatingCart: "خطأ في تحديث العربة",
  pleaseSignInToAddToCart: "يرجى تسجيل الدخول لإضافة عناصر إلى العربة",
  ...
  // Signin Component (Previously added)
  ...
  or: "أو",
  google: "جوجل",
  welcomeBack: "مرحبًا بعودتك! يرجى تسجيل الدخول للمتابعة.",
  ...
  // Register Component (New keys added)
  createAccount: "إنشاء حساب",
  joinUs: "انضم إلينا! أنشئ حسابك للبدء.",
  ...
  invalidName: "اسم غير صالح (3-15 حرفًا، أحرف، أرقام، _، -)",
  invalidUsername: "اسم مستخدم غير صالح (3-15 حرفًا، أحرف، أرقام، _، -)",
  invalidPassword: "كلمة المرور يجب أن تكون 8+ أحرف مع أحرف كبيرة، صغيرة، رقم، وحرف خاص",
  emailInUse: "البريد الإلكتروني مستخدم بالفعل",
  firebaseError: "خطأ في Firebase",
  gallery: "معرضنا",
checkOurGallery: "تحقق من ",
theOriginalFoodTaste: "الطعم الأصلي للطعام",
tryOur: "جرب",
meals: "وجبات",
desserts: "حلويات",
appetizers: "مقبلات",
